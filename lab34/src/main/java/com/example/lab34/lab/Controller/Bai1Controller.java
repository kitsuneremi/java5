package com.example.lab34.lab.Controller;

import com.example.lab34.lab.Models.Bai1Model;
import com.example.lab34.lab.Service.Bai1Service;
...
public class Bai1Controller {
    ...
    @PostMapping("/add")
    public String add(Model model, @RequestParam String mamon, @RequestParam String tenmon, @RequestParam int stc, @RequestParam int chuyennganh, @RequestParam int[] giangvien, @RequestParam int batbuoc  ){
